...
namespace Client.UI.Base.Controls
{
    public partial class ImageProcessBox : Control
    {
        ...
        {
            if (e.KeyChar == 'w')
                Client.Core.Win32.NativeMethods.SetCursorPos(MousePosition.X, MousePosition.Y - 1);
            else if (e.KeyChar == 's')
                Client.Core.Win32.NativeMethods.SetCursorPos(MousePosition.X, MousePosition.Y + 1);
            else if (e.KeyChar == 'a')
                Client.Core.Win32.NativeMethods.SetCursorPos(MousePosition.X - 1, MousePosition.Y);
            else if (e.KeyChar == 'd')
                Client.Core.Win32.NativeMethods.SetCursorPos(MousePosition.X + 1, MousePosition.Y);
            base.OnKeyPress(e);
        }
