...
namespace Client.UI.Base.Controls
{
    ...
    public class SkinTabControl : TabControl
    {
        ...
        private SkinTabControl.UpDownButtonNativeWindow _upDownButtonNativeWindow;
        ...
        private SkinTabControl.ePageImagePosition pageImagePosition;
        ...
        [DefaultValue(typeof(SkinTabControl.ePageImagePosition), "Overlay")]
        [Description("指定选项卡上图像与文本的对齐方式")]
        [Category("Page")]
        public SkinTabControl.ePageImagePosition PageImagePosition
        {
            get
            {
        ...
        public event UpDownButtonPaintEventHandler PaintUpDownButton
        {
            add
            {
                this.Events.AddHandler(SkinTabControl.EventPaintUpDownButton, (Delegate)value);
            }
            remove
            {
                this.Events.RemoveHandler(SkinTabControl.EventPaintUpDownButton, (Delegate)value);
            }
        }

        static SkinTabControl()
        {
            SkinTabControl.EventPaintUpDownButton = new object();
        }
        ...
        public SkinTabControl()
        {
            ...
            this.SetStyles();
            this.animator = new SkinAnimator();
        ...
        protected virtual void OnPaintUpDownButton(UpDownButtonPaintEventArgs e)
        {
            ...
            UpDownButtonPaintEventHandler paintEventHandler = this.Events[SkinTabControl.EventPaintUpDownButton] as UpDownButtonPaintEventHandler;
        ...
        protected override void OnHandleCreated(EventArgs e)
        {
            ...
            if (!(this.UpDownButtonHandle != IntPtr.Zero) || this._upDownButtonNativeWindow != null)
                return;
            this._upDownButtonNativeWindow = new SkinTabControl.UpDownButtonNativeWindow(this);
        }
        ...
        protected override void OnHandleDestroyed(EventArgs e)
        {
            ...
            this._upDownButtonNativeWindow = (SkinTabControl.UpDownButtonNativeWindow)null;
        }
        ...
        private void CalculateRect(TabPage page, Rectangle tabRect, out Rectangle imageRect, out Rectangle textRect)
        {
            ...
            else
            {
                ...
                {
                    case SkinTabControl.ePageImagePosition.Left:
                    ...
                    case SkinTabControl.ePageImagePosition.Right:
                        if (this.PageTextAlign != ContentAlignment.BottomLeft && this.PageTextAlign != ContentAlignment.MiddleLeft && this.PageTextAlign != ContentAlignment.TopLeft)
                        {
                            if (this.PageTextAlign != ContentAlignment.BottomCenter && this.PageTextAlign != ContentAlignment.MiddleCenter && this.PageTextAlign != ContentAlignment.TopCenter)
                            {
                    ...
                    case SkinTabControl.ePageImagePosition.Top:
                        ...
                        break;
                    case SkinTabControl.ePageImagePosition.Bottom:
        ...
        private void DrawTabPages(PaintEventArgs e)
        {
            ...
            for (int index = 0; index < this.TabCount; ++index)
            {
                ...
                if (this.DrawType == DrawStyle.Img && image1 != null)
                {
                    ...
                    if (this.PagePalace)
                        ImageDrawRect.DrawRect(graphics, (Bitmap)image1, rectangle, Rectangle.FromLTRB(this.PageBackRectangle.X, this.PageBackRectangle.Y, this.PageBackRectangle.Width, this.PageBackRectangle.Height), 1, 1);
                    else
        ...
        public TextFormatFlags GetTextFormatFlags(ContentAlignment alignment, bool rightToleft, TabPage page)
        {
            ...
            if ((this.PageImagePosition == SkinTabControl.ePageImagePosition.Left || this.PageImagePosition == SkinTabControl.ePageImagePosition.Right) && image != null)
        ...
        private class UpDownButtonNativeWindow : NativeWindow, IDisposable
        {
            ...
            public void Dispose()
            {
                this._owner = (SkinTabControl)null;
                this.ReleaseHandle();
            }
        }
    }
